      ...
      <footer className="w-full bg-gray-900 text-gray-400 text-sm text-center py-6">
        <div className="flex justify-center items-center space-x-6 mb-2">
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="group flex items-center space-x-2 hover:text-white transition-colors duration-200"
          >
            <svg
              className="w-6 h-6 transition-colors duration-200 fill-current group-hover:fill-white"
              viewBox="0 0 24 24"
            ...
            <span className="text-lg font-semibold group-hover:text-white transition-colors duration-200">
              GitHub
            </span>
          </a>
