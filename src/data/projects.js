const projects = [
    {
      ...
      tags: ['React', 'Tailwind', 'Canvas', 'Vite', 'game'],
    ...
    },
    {
      ...
      image: '/images/crypto.png', // Update with actual screenshot path
      video: '', // Optional
    ...
    },
    {
      ...
      image: '/images/crypto.png', // replace with your actual image path
      video: '', // optional: could add a demo video later
      github: 'https://github.com/nicorox247/muscle-map', // update if private or unlinked
      live: '', // optional: add deployment link if it's hosted
      tags: ['JavaScript', 'Flask', 'Python', 'Bootstrap', 'Anatomy', 'Fitness'],
