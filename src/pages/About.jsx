...
export default function About() {
    ...
    return (
        <div>
            ...
            {/* Timeline section */}
            <div className="relative h-[1200px] overflow-hidden bg-[#0f172a] text-white">
                <h1 className="text-4xl font-bold text-center pt-10 pb-6">About Me</h1>

                <div className="absolute top-1/2 left-1/2 w-[4px] h-full bg-white transform -translate-x-1/2 -translate-y-1/2 z-0" />

                {timelineData.map((item, index) => (
                    <TimelineNode key={index} index={index} {...item} />
                ))}

                <AthleteSprite activeIndex={activeIndex} isRunning={isRunning} />
